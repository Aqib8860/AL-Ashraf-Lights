...
const Footer = () => {
    return (
        ...
        <footer className="relative bg-blueGray-200 pt-8 pb-6 bg-gray-400 ">
        <div className="container mx-auto px-4">
            ...
            <div className="w-full lg:w-6/12 px-4">
                ...
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                    ...
                    <li>
                        <a className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="https://www.github.com/creativetimofficial?ref=njs-profile">Contact Us</a>
                    </li>
                    <li>
            ...
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                ...
                <a href="https://www.creative-tim.com/product/notus-js" className="text-blueGray-500 hover:text-gray-800" target="_blank"> Ashrafi Lights</a>
                </div>
            </div>
            </div>
        </div>
